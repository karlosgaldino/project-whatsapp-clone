...
export class WhatsAppController{
    ...
    setActiveChat(contact){
        ...
        Message.getRef(this._contactActive.chatId).orderBy('timeStamp').onSnapshot(docs=>{
            ...
            var scrollTop = this.el.panelMessagesContainer.scrollTop;
            ...
            if(autoScroll){
                ...
                this.panelMessagesContainer.scrollTop = scrollTop;
            }   
        })
    ...
    initEvents(){
        ...
        this.el.formPanelAddContact.on('submit', e=>{
            ...
            contact.on('datachange', data=>{
                if(data.name){
                    ...
                    console.error('Ussuário não foi encontrado.');
                }
            })
        });
            ...
            if(this.el.inputDocument.files.length){
                ...
                this._documentPreviewController.getPreviewData().then(result=>{
                    ...
                    switch(file.type){
                        ...
                        case 'application/vnd.openxmlformats-officedocument.presentationnml.presentation':
                            this.el.iconPanelDocumentPreview.className = 'jcxhw icon-doc-ptt';
                            break;
        ...
        this.el.btnSendMicrophone.on('click', e=>{
            ...
            this._microfoneController = new MicrofoneController();

            
            this._microfoneController.on('ready', audio=>{
                
                console.log('redy event');
                this._microfoneController.startRecorder();

                this._microfoneController.on('recorderTimer', timer=>{
        ...
        this.el.btnCancelMicrophone.on('click', e=>{
            ...
            this._microfoneController.stopRecorder();
            this.closeRecordMicrofone();
        });

        this.el.btnFinishMicrophone.on('click', e=>{

            this._microfoneController.on('recorded', (file, metadata)=>{
